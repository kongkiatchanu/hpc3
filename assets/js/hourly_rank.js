                    ...
                    columnDefs: [{
                        ...
                        createdCell: function (td, cellData, rowData, row, col) {
                            ...
                            createdCell: function (td, cellData, rowData, row, col) {
                                ...
                                var valpm25 = rowData.pm25 >0 ? rowData.pm25 : 'Offline';
                                $(td).html('<a class="font-weight-bold badge badge-pill p-1 w-sm slit_in_vertical_table" style="width: 4vw; font-size:14px; background-color:rgba(' + color_table + ')";> ' + valpm25 + ' </a>');
